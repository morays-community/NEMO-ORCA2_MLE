...
#  --------- DO NOT MODIFY --------
# ================================= #
fake_models = types.ModuleType("submeso_ml.models")
sys.modules["submeso_ml.models"] = fake_models
sys.modules["submeso_ml.models.fcnn"] = submeso_ml.cnn.fcnn
...
norms['means']['WB_sg'] = np.load( norm_path + '/norm_1_4' + '/WB_sg_mean.npy' )
norms['devs']['WB_sg'] = np.load( norm_path + '/norm_1_4' + '/WB_sg_std.npy' )

for name in input_string:
    file_mean = norm_path + '/norm_1_4' + '/' + name + '_mean.npy'
    file_dev = norm_path + '/norm_1_4' +  '/' + name  + '_std.npy'
